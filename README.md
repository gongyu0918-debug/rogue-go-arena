...
| 封印术 | 指定 3 个禁着点，AI 前 8 手都不能下在这些点 |
| 连击 | 本回合可连续落两手（限 1 次） |
...
| 镜像 | AI 有 24% 概率模仿你的上一手 |
| 手滑了 | AI 有 20% 概率手滑到相邻的点位 |
| 黑洞 | 棋盘中心 13 路区域对 AI 前 10 手禁入 |
| 乾坤挪移 | 强制 AI 虚手，你继续行棋（限 1 次） |
| 战争迷雾 | AI 前 6 手每手前会刷新一个 3×3 禁区遮罩 |
| 星位引力 | AI 前 5 手被星位磁场牵引 |
| 黄金角 | 随机封锁一角 4×4 区域，AI 前 10 手禁入 |
| 三三开局 | 开局前 2 手强制 AI 去抢四个三三点中的任意点，之后 2 手暂时避开角上 4×4 区域 |
| 影子 | AI 前 2 手有较高概率紧跟自己的上一手 |
| 萌芽 | 每次提子后，都会在附近自动长出 1 颗己棋 |
| 定式强迫症 | 开局亮出 5 个目标点，只要下中 3 个，剩下的 2 个会自动补成你的棋子 |
| 让子任务 | 先虚手 1 次，之后每满 6 手奖励 AI 虚手一次，最多触发 3 次 |
| 神之一手 | 踩中隐藏菱形区，周围 3×3 内随机爆出 2 颗己棋，只会落在空点 |
| 三三陷阱 | 只要对手的第 1 手正好落在四个三三点之一，就会在那手棋周围反生 3 颗我方棋 |
| 守角辅助 | 任一角的 5×5 区域里有 2 颗己子时，就会在那个角补 2 颗援军 |
| 三连星 | 前 4 手里只要有 2 手落在星位，就会额外生成 2 颗己棋 |
| 永不悔棋 | 禁用悔棋，但每手 8% 概率白送一子 |
| 快速思考 | 5 秒内落子可追加 3 秒连击窗口 |
